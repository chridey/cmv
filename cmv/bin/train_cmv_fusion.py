...
def train_model(params, serialization_dir, cuda_device=-1, use_validation_data=True):
    ...
    train_data = dataset_reader.read(**data_params['train'])
...
train_model(params, args.logdir, args.cuda_device)
