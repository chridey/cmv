...
defaultConfig = {
    ...
    'featureSettings': {'causal_pct': True, #explicit causal connectives
                        ...
                        'noncausal_altlex_pct': False,
                        'wordnet_response': False,
                        'verbnet_response': False,
                        'wordnet_title_response_interaction': False, #title, all roots and arguments
                        'wordnet_post_response_interaction': False, #OP, all roots and arguments
                        'verbnet_title_response_interaction': False, #title, all roots and arguments
                        'verbnet_post_response_interaction': False, #OP, all roots and arguments
